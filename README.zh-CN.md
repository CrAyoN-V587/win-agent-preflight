...
[`v0.1.0`](https://github.com/CrAyoN-V587/win-agent-preflight/releases/tag/v0.1.0) 已从提交 `33cbb6e` 发布。Windows CI 已在 Python 3.12 和 3.14 上通过，Release 附带经过验收的 sdist 和 wheel。功能开发现已暂缓；维护、文档修正和反馈响应继续。
...
外部试运行手册仍可供愿意提供脱敏报告的参与者使用；外部测试不是 v0.1.0 发布的前置条件，也不是维持暂缓状态的前置条件。
